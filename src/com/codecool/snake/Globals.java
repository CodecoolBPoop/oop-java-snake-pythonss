...
public class Globals {
    ...
    public void setupResources() {
        ...
        resources.addImage("SnakeHead", new Image("python.png"));
        resources.addImage("SnakeBody", new Image("python.png"));
        resources.addImage("SimpleEnemy", new Image("intellij.png"));
        resources.addImage("PowerUpBerry", new Image("python.png"));
        resources.addImage("Laser", new Image("pycharm.png"));
        resources.addImage("ChasingEnemy", new Image("curly.png"));
        resources.addImage("ChasingEnemy1", new Image("curly_1.png"));
